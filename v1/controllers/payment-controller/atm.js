...
module.exports = async (req, res) => {
    const { merID, merKey, merIv, prodDesc, tradeAmt, bankType, userMail, carrierType, carrierInfo, invBuyerName, isSandbox } = req.body;
    ...
    const apiUrl = getPayuniUrl('atm', isSandbox);
